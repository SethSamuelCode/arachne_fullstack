...
PINNED_TEXT_EXTENSIONS: frozenset[str] = frozenset({
    ...
    ".h", ".hpp", ".cs", ".php", ".swift", ".kt", ".kts", ".scala", ".rs",
    ".lua", ".pl", ".pm", ".ex", ".exs", ".erl", ".hs", ".ml", ".mli", ".fs",
    ".fsx", ".clj", ".cljs", ".vue", ".svelte", ".astro", ".graphql", ".gql",
    ".proto", ".dockerfile", ".gitignore", ".editorconfig", ".prettierrc",
    ".eslintrc", ".babelrc", ".env.example", ".env.local", ".env.development",
    ".env.production", ".env.test", "makefile", ".mk", ".cmake", ".gradle",
    ".sbt", ".pom", ".csproj", ".fsproj", ".vbproj", ".sln",
})
