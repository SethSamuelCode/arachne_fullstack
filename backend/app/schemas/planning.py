...
class SingleTask(BaseModel):
    ...
    task_completed: bool = Field(
        default=False, description="Indicates whether the task has been completed."
    )
    task_status: Literal["pending", "in_progress", "completed"] = Field(
        default="pending",
...
class Plan(BaseModel):
    ...
    plan_description: str = Field(
        ...
        examples=[
            "This plan outlines the steps to successfully launch the new product.",
            "This plan details the marketing strategies for the upcoming quarter.",
        ],
    )
    ...
    plan_completed: bool = Field(
        default=False, description="Indicates whether the plan has been completed."
    )
    ...
    updated_at: datetime | None = Field(
        default=None, description="Timestamp when the plan was last updated."
    )
...
class SingleTaskUpdate(BaseModel):
    ...
    task_description: str | None = Field(
        default=None, description="Description of the task and what needs to be done."
    )
    task_notes: str | None = Field(
        default=None, description="Additional notes or context for the task."
    )
    task_completed: bool | None = Field(
        default=None, description="Indicates whether the task has been completed."
    )
    task_status: Literal["pending", "in_progress", "completed"] | None = Field(
...
class PlanUpdate(BaseModel):
    ...
    plan_description: str | None = Field(
        default=None, description="Detailed description of the plan and its objectives."
    )
    steps: list[SingleTaskUpdate] | None = Field(
        default=None,
        description="List of task updates. Only provided fields per task will be updated.",
    )
    plan_notes: str | None = Field(
        default=None, description="Additional notes or context for the plan."
    )
    plan_completed: bool | None = Field(
        default=None, description="Indicates whether the plan has been completed."
    )
